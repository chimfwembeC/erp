...
export default function FooterComponents(editor: grapesjs.Editor) {
  // Hero Section
  editor.BlockManager.add('Footer-with-social-icons', {
    label: 'Footer with social icons',
    content: `
  ...
  editor.BlockManager.add('Footer-with-social-media-buttons', {
    label: 'Footer with social media buttons ',
    content: `
  ...
  editor.BlockManager.add('Small-Footer', {
    label: 'Small Footer ',
    content: `
   <footer class="text-sm leading-6 mt-8 px-3">
    <div class="pt-10 pb-28 border-t border-slate-200 sm:flex justify-between text-slate-500">
        <div class="mb-6 sm:mb-0 sm:flex">
            ...
            <p class="sm:ml-4 sm:pl-4 sm:border-l sm:border-slate-200"><a
                    class="hover:text-slate-900" href="/brand">Trademark Policy</a>
            </p>
        </div>
