...
export default function PricingComponents(editor: grapesjs.Editor) {


    editor.BlockManager.add('pricing-section-1',{ 
        lable: 'Pricing Section',
        content: `<section class="px-8 py-24">
