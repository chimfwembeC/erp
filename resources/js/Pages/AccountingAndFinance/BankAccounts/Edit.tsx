  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      const result = await Swal.fire({
        title: 'Are you sure?',
        text: 'Do you want to update this bank account?',
        icon: 'warning',
      ...
      if (result.isConfirmed) {
        ...
        router.put(route('accounting.bank-accounts.update', bankAccount.id), accountData, {
          onSuccess: () => {
            Swal.fire(
              'Updated!',
          ...
          onError: () => {
            Swal.fire(
              'Error',
              'There was an issue updating the bank account.',
              'error'
            );
          },
