...
const Edit = ({ group, employees }) => {
  ...
  const handleSubmit = e => {
    e.preventDefault();
    router.put(route('hrm.department-groups.update', group.id), formData, {
      onSuccess: () => {
        Swal.fire(
          'Updated!',
          'The department group has been Updated successfully.',
          'success',
        ).then(() => {
      ...
      onError: error => {
        Swal.fire(
          'Error',
          'There was an issue creating the department group.',
          'error',
        );
      },
    });
  ...
  return (
    <AppLayout title="Update Department Group">
