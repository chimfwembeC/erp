...
const Index = ({ departments }) => {
  ...
  const handleDelete = departmentId => {
    Swal.fire({
      title: 'Are you sure?',
      text: 'This action will delete the department permanently.',
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        router.delete(
          route('hrm.departments.destroy', departmentId),
        );
    ...
    return (
      <div className="flex gap-2">
        <Button
          ...
          rounded
          onClick={() => router.get(route('hrm.departments.show', rowData.id))}
        ...
        <Button
          ...
          rounded
          onClick={() => router.get(route('hrm.departments.edit', rowData.id))}
      ...
      <div className="p-6 bg-white shadow-md rounded-lg">
        <div className="flex justify-between items-center mb-4">
          ...
          <Button
            ...
            onClick={() => router.get(route('hrm.departments.create'))}
          />
        </div>
